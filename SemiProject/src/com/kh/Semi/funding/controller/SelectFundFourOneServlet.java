 ...
 */
@WebServlet("/selectFundFourOne")
public class SelectFundFourOneServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectFundFourOneServlet() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		ArrayList<ProductList> list = new FundingService().selectFundFourListOne(Integer.parseInt(num), progress, catagory); 
