...
/**
 * Servlet implementation class SearchAllQnaServlet
 */
@WebServlet("/searchAllQna.hp")
public class SearchAllQnaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchAllQnaServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list != null){
			page = "views/helpDesk/help_All.jsp";
