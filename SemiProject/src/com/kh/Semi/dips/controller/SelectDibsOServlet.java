 ...
 */
@WebServlet("/selectDibsO")
public class SelectDibsOServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectDibsOServlet() {
        super();
	...
	ArrayList<Dibs> list = new DibsService().selectListO(userNo);
