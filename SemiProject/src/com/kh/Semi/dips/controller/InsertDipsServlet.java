...
/**
 * Servlet implementation class InsertDipsServlet
 */
@WebServlet("/insertDibs")
public class InsertDipsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertDipsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		int result = new DibsService().insertDibs(dib);
