...
/**
 * Servlet implementation class SelectWaybillServlet
 */
@WebServlet("/selectWaybill")
public class SelectWaybillServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectWaybillServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list != null){
			page = "views/seller/insertWaybill.jsp";
