...
/**
 * Servlet implementation class InsertFacingServlet
 */
@WebServlet("/InsertMail.fa")
public class InsertFacingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertFacingServlet() {
        super();
