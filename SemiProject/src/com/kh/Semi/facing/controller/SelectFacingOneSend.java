...
/**
 * Servlet implementation class SelectFacingOneSend
 */
@WebServlet("/sendSelectOne.fa")
public class SelectFacingOneSend extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectFacingOneSend() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Facing f = new FacingService().sendSelectOne(num);
		
		String page = null;
		
		System.out.println("한개보는 서블릿 : " + f);
		if(f != null){
			page = "views/mail/mailSendBox.jsp";
