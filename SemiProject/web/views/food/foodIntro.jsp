<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	com.kh.Semi.dips.model.vo.*,com.kh.Semi.funding.model.vo.*,com.kh.Semi.basket.model.vo.*"%>
...
<link href="<%= request.getContextPath() %>/css/food/foodIntro.css" rel="stylesheet">
		...
		<div class="dofunding">
			...
			<div style="margin-top:25px">
				<div style="float:right; margin-right:110px;">
					<i class="fas fa-cart-arrow-down" id="cart" style="font-size:40px;" onclick="cart(<%=pnum %>, this)" value='<%=pnum %>'></i>
				</div> 
					
				<div style="float:left; margin-left:140px;">
					<i class="far fa-heart" id="dips" style="font-size:40px;" onclick='dips(<%=pnum %>, this);' value='<%=pnum %>'></i>
				</div>
			...
			<div style="margin-top:25px">
				<div style="float:right; margin-right:110px;">
					<i class="fas fa-cart-arrow-down" id="cart" style="font-size:40px;" onclick="location.href='#';"></i>
				</div>
				<div style="float:left; margin-left:140px;">
					<i class="far fa-heart" id="dips" style="font-size:40px;" onclick='dips(<%=pnum %>, this);' value='<%=pnum %>' id='heart'></i>
				</div>
