<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    import="com.kh.Semi.facing.controller.*"
    %>
...
.view_contentstext{padding:20px; margin-left:-120px; margin-top:20px; float:left;}
...
<div id="page" class="container">
	...
	<div class="board_main" style="width:800px; height:400px;">
		<div class="view_header">
			...
			<div class="view_info">
				<div class="preson" style="float:left">보낸사람 &nbsp;<%=f.getWriter() %></div>
				<div class="data">
					<span>보낸날짜 </span>
		...
		<div class="reply-bottom" align="right">
			<input type="button" class="btn" value="삭제" onclick="deleteMail();" style="width:100px; height:40px; margin-top:10px; background-color:green; color:white;"></input>
			<input type="button" class="btn" value="답장" onclick="location.href='<%=request.getContextPath()%>/reMailFacing.fa?num=<%=f.getFacing_No()%>'" style="width:100px; height:40px; margin-top:10px; background-color:green; color:white;"></input>
			<input type="button" class="btn" value="목록" onclick="location.href='<%=request.getContextPath()%>/selectList.fa'"style="width:100px; height:40px; margin-top:10px; background-color:green; color:white;"></input>
		</div>
    	
    	<script>
    		function deleteMail(){
    			alert("쪽지가 삭제되었습니다.");
    			location.href="<%=request.getContextPath()%>/deleteFacing.fa?num=<%=f.getFacing_No()%>";
    		}
    		
    		function returnMail(){
    			location.href="<%=request.getContextPath()%>/reMailFacing.fa?num=<%=f.getFacing_No()%>";
    		}
    	</script>
