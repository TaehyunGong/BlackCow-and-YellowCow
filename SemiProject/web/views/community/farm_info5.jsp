...
.farmInfo-text1:hover{cursor:pointer;}
	...
	$(function(){
		$.ajax({
			url:"http://api.nongsaro.go.kr/service/farmDic/detailLikeWordList?apiKey=20180822P8XL8HHAFE05EWZ6F6BGRG",
			type:"GET",
	...
	function fncThesaurusDtl(wordNm, faoCode){
		window.open("farmDicPop.html?wordNm="+encodeURI(encodeURIComponent(wordNm))+"&faoCode="+faoCode, "nongsaroPop","width=800,height=600,scrollbars=yes");
	}
	...
	<%-- nongsaroOpenApiRequest.apiKey = "20180822P8XL8HHAFE05EWZ6F6BGRG";
	nongsaroOpenApiRequest.serviceName = "farmDic";
	nongsaroOpenApiRequest.operationName = "thesaurusDtlTerm";
	nongsaroOpenApiRequest.wordNm = decodeURIComponent(nongsaroOpenApiPopRequest("wordNm"));
	nongsaroOpenApiRequest.faoCode = nongsaroOpenApiPopRequest("faoCode");
	nongsaroOpenApiRequest.htmlArea="nongsaroApiLoadingArea";
	nongsaroOpenApiRequest.callback = "<%=request.getContextPath()%>/views/community/ajax_local_callback.jsp"; --%>
