...
.farmInfo-text1:hover{cursor:pointer;}
	...
	$(function(){
		$.ajax({
			url:"http://api.nongsaro.go.kr/service/farmWorkingPlan/workScheduleGrpList?apiKey=20180822P8XL8HHAFE05EWZ6F6BGRG",
			type:"GET",
	...
	nongsaroOpenApiRequest.serviceName = "farmWorkingPlan";
	nongsaroOpenApiRequest.operationName = "workScheduleGrpList";
