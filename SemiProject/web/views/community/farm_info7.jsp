...
.farmInfo-text1:hover{cursor:pointer;}
	...
	$(function(){
		$.ajax({
			url:"http://api.nongsaro.go.kr/service/elctrnCvpl/elctrnCvplList?apiKey=20180822P8XL8HHAFE05EWZ6F6BGRG",
			type:"GET",
	...
	nongsaroOpenApiRequest.serviceName = "elctrnCvpl";
	nongsaroOpenApiRequest.operationName = "elctrnCvplList";
