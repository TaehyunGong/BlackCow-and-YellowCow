...
.farmInfo-text1:hover{cursor:pointer;}
	...
	$(function(){
		$.ajax({
			url:"api.nongsaro.go.kr/service/sptTchnlgySport/sptTchnlgySportList?apiKey=20180822P8XL8HHAFE05EWZ6F6BGRG",
			type:"GET",
	...
	nongsaroOpenApiRequest.serviceName = "sptTchnlgySport";
	nongsaroOpenApiRequest.operationName = "sptTchnlgySportList";
