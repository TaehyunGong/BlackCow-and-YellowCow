			...
			<div class="right_col" role="main">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form id="demo-form" data-parsley-validate action="<%=request.getContextPath() %>/sellerRetire" method="post" autocomplete="off">
                    <label for="password">비밀번호 입력 </label>
                    <input type="password" id="password" class="form-control" name="password" required autocomplete="off"/><br>
