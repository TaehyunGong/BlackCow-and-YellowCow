...
<script>
   ...
   <%@ include file="../common/navbar.jsp" %>
	...
	<div id="freeboardtext">
		<h2 id="text-free-1">문의하기</h2>
	</div>
	<div id="text-free-2">- 문의 내용과 맞지않는 문의유형을 선택하실 경우 답변이 지연될 수 있습니다.</div>
	<form name="writeForm" action="<%=request.getContextPath()%>/insert.hp" method="post">
	<div class="board_main">
		...
		<thead>
			<tr>
				...
				<!-- <th class="text-center"><strong style="color:#000;">유형</strong></th>
			...
			<tr>
				...
				<td colspan="4" class="t_tit">
					<textarea name="title" id="qnaTitle" style="width:950px; height:25px; resize:none; overflow:hidden;"></textarea>
				</td>
			</tr>
			<tr>
				<td class="t_type t_name">문의내용</td>
				<td colspan="4" class="t_tit">
					<textarea name="content" id="summernote" style="width:950px; height:400px; resize:none;"></textarea>
					<script>
					$(function(){
	...
	<div class="write-bottom">
		<!-- <input type="reset" id="resetQna" value="작성취소" class="btn btn-write"> -->&nbsp;&nbsp;
        <button type="submit" value="접수하기" id="btnQna" class="btn btn-write">접수하기</button><br>
        <script>
        	$(function(){
