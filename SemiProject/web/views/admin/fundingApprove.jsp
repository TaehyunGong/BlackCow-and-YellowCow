...
<body class="nav-md">
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>펀딩 신청 관리<small>(상품 소개 확인은 상품명을 클릭하세요)</small></h2>
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <% for(HashMap<String, Object> h : list) { %>
                   	<tr>
                   		...
                   		<td><button class="btn btn-warning btn-xs farmArea">밭 면적 보기</button></td>
	...
	<script>
	   ...
	   $(function(){
		   $(".farmArea").click(function(){
			var member_id = $(this).parent().parent().children(".member_id").val();
			var popUrl = "<%=request.getContextPath() %>/viewFarm?member_id=" + member_id;	/* 팝업창에 출력될 페이지 URL */
			var popOption = "width=635, height=560, resizable=no, scrollbars=no, status=no,location=no;";    //팝업창 옵션(optoin)
			   ...
			   $.ajax({
				   ...
				   success : function(data){
					   ...
					   if(result > 0){
						   ...
						   location.replace("<%=request.getContextPath()%>/fundingApprove");
					   }else{
						   console.log('상품승인 실패');
						   location.reload();
					   }
