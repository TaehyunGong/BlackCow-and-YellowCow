<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	ArrayList<Board> story = (ArrayList<Board>)request.getAttribute("story");
...
<link href="<%= request.getContextPath() %>/css/funding/story.css" rel="stylesheet">
...
font-family: 'Nanum Pen Script', cursive; font-size:80px;"><%=intro.get("pro_name") %></p>
	...
	<div id="tabMenu">
		...
		<button class="tablinks active" onclick="category(event)" id="story"
	...
	<div class="storyArea">
		...
		<div class="leftArea">
			...
			<% if(story != null && story.size() != 0){
				...
				for(int i=0; i < story.size(); i++) {%>
					<button class="accordion"><%=story.get(i).getWrite_Date() %>&nbsp;&nbsp;&nbsp;<i class="fas fa-angle-down"></i></button>
						<div class="panel">
							<%=story.get(i).getBoard_Content() %>
			...
			<!-- <button class="accordion">18.08.09 (목)&nbsp;&nbsp;&nbsp;<i class="fas fa-angle-down"></i></button>
			<div class="panel">
				<img class="storyImg" src="../../images/funding/cheken.jpg">
		...
		<%-- <div class="rightArea">
				<div class="chartArea">
					...
					<div class="chart">	
						...
						<div style="width:100%; padding:3px; font-weight:bold;">
							<div class="chartOrder"><%=i %></div>
						
							<div class="chartContent"><a class="chartlink" href="#">내용내용내용내내용내용내용내용내내용내내용내내내</a></div>
						</div>
				...
				<div class="chartArea">
					<div class="chartOuter">
						<h6 style="margin-left:10px; font-weight:bold">관련 프로젝트</h6>
							<hr style="width:95%" >
					<div class="chart">	
	...
	<script src="<%= request.getContextPath() %>/js/funding/story.js"></script>
